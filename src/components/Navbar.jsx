...
const Navbar = () => {
  ...
  return (
    <div className="navbar text-white bg-[#4a4a4d] fixed z-10 backdrop-blur-3xl">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <div
            tabIndex={0}
            className="menu menu-sm dropdown-content rounded-box z-[1] mt-3 w-52 p-2 shadow bg-[#4a4a4d]"
          >
