...
const Slider = () => {
  ...
  return (
    <AutoplaySlider
      ...
      interval={3000}
    >
      <div className="w-full min-h-screen slider1 flex items-center justify-center text-white text-center">
        <div>
      ...
      <div className="w-full min-h-screen slider2 flex items-center justify-center text-white text-center">
        <div>
      ...
      <div className="w-full min-h-screen slider3 flex items-center justify-center text-white text-center">
        <div>
